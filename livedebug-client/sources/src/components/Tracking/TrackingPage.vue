              ...
              <div class="col-md-6 offset-md-3">
                ...
                <form @submit.prevent="onSubmit">
                  <div class="input-group input-group-lg shadow-card mb-3">
                    <input class="form-control form-control-lg py-2 border-right-0 border" type="search" placeholder="search" id="example-search-input" aria-label="Find by country name" v-model="searchQuery">
